...
namespace DAL
{
    ...
    public partial class SC_ROLES
    {
        ...
        public SC_ROLES()
        {
            this.SC_USER_ROLES = new HashSet<SC_USER_ROLES>();
            this.SC_USERS = new HashSet<SC_USERS>();
        }
    
        public string ROL_ROLENAME { get; set; }
        public Nullable<bool> ROL_USE_ADMIN { get; set; }
        public Nullable<bool> ROL_USE_ADD_WORKER { get; set; }
        public Nullable<bool> ROL_USE_SEE_WORKER { get; set; }
        public Nullable<bool> ROL_USE_LIST_WORKER { get; set; }
        public Nullable<bool> ROL_USE_ADD_CLIENT { get; set; }
        public Nullable<bool> ROL_USE_LIST_CLIENT { get; set; }
        public Nullable<bool> ROL_USE_ADD_ORDER { get; set; }
        public Nullable<bool> ROL_USE_PRINT_BAGES { get; set; }
        public Nullable<bool> ROL_USE_CLIENT_DETAILS { get; set; }
        public Nullable<bool> ROL_USE_WORKER_CALL { get; set; }
        public Nullable<bool> ROL_USE_WORKER_CALCULATION { get; set; }
        public Nullable<bool> ROL_USE_CASH_REPORT { get; set; }
        public Nullable<bool> ROL_USE_WORKER_MANAGER_REP { get; set; }
        public Nullable<bool> ROL_USE_CC_MAN_REP { get; set; }
        public Nullable<bool> ROL_USE_REP_WORKED_HOURS { get; set; }
        public Nullable<bool> ROL_USE_WORKER_BONUS { get; set; }
        ...
        public Nullable<bool> ROL_USE_ADD_DOCS_TO_FMS { get; set; }
        public Nullable<bool> ROL_USE_HOSTELS_PAGE { get; set; }
        public bool ROL_USE_INTERVIEWS { get; set; }
        public Nullable<bool> ROL_USE_ORDER_POST_EDIT { get; set; }
        ...
        public Nullable<bool> ROL_USE_WRITE_OFF_WEALTH { get; set; }
        ...
        public Nullable<bool> ROL_USE_KEEP_ALL_ONCE { get; set; }
        public Nullable<bool> ROL_USE_CALC_ACTIVE_ORDERS { get; set; }
        public Nullable<bool> ROL_USE_ADD_NET { get; set; }
        ...
        public Nullable<bool> ROL_USE_TRAINING_CENTRES_LIST { get; set; }
